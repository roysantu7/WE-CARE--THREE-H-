      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="thread.jsp" class="glyphicon glyphicon-user"> MESSAGE</a></li>
...
<%
  try{
	  ...
	  Connection con=New_con.getCon();
		...
		String sql="select name,email,pass,loc,gender,mob,age,role from registration where email=?";
...
<div class="container-fluid text-center">
    ...
    <div class="row">
      <div class="col-md-5">
 		 ...
 		 <div class="panel panel-default text-center" style="background-color: #92a8d1; padding-bottom: 5px;">
       ...
       <div class="panel-body" style="background-color: #555555;">
        <form role="form" action="Upload">
          ...
          <table align="center" style="color: #ffcc5c;font-size: medium;">
			...
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Gender:</td>
			<td style="text-align: left;" class="form-control"><select name="gen"  style="width: 200px;">
              <option><%=rs.getString(5)%></option><option>Male</option>
              <option>Female</option><option>Others</option>
              </select></td></tr>
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Age:</td>
			<td style="text-align: left;" class="form-control"><input type="text" name="age" value="<%=rs.getString(7) %>"></td></tr>
      ...
      <div class="modal-footer">
        ...
        <div class="panel-body" style="background-color: #555555;">
          <table align="center" style="color: #ffcc5c;font-size: medium;">
			...
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Lives in:</td><td style="text-align: left;" class="form-control"><%=rs.getString(4) %></td></tr>
			...
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Gender:</td><td style="text-align: left;" class="form-control"><%=rs.getString(5) %></td></tr>
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Age:</td><td style="text-align: left;" class="form-control"><%=rs.getString(7) %></td></tr>
        ...
        <div class="panel panel-default text-center" style="background-color: #92a8d1; padding-bottom: 20px;">
        	...
        	<div class="panel-body" style="background-color: #555555;padding-bottom: 25px;">
        	    <form class="form-inline" action="Post" method="post" enctype="multipart/form-data">
    	  			...
    	  			<p></p>
    	  			<input type="file" placeholder="Upload photo (if any)" size="20" style="" name="pic" class="form-control">
     ...
     <%
      try{
    	  ...
    	  String sql1="select name,email,pic,msg,id,sdate,stime,title from udata where email=?";
    		...
    		%>
    <div class="col-md-7">
      <div class="bg-grey" style="margin-top: 10px;padding: 10px; border: 1px;border-color: #555555;" >
      <div class="row">
        <div class="col-md-6 form-group">
          <h3><%=nam %>
             <button class="btn btn-link glyphicon glyphicon-trash" data-toggle="modal" data-target="#myModalDel" 
             title="Delete Post" style="float: right;">
              </button>
          </h3>
           
          <p style="font-size: small; margin-bottom: 0px;">
          on <%=rs1.getString(6) %> at <%=rs1.getString(7) %>
          </p>
        </div>
      </div>
      <div class="row">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <h4 style="text-align: center;"><span class="glyphicon"></span>Do you really want to delete this post? </h4>
