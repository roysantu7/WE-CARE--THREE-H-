       ...
       <div class="panel-body" style="background-color: #555555;">
        <form role="form" action="Upload">
          ...
          <table align="center" style="color: #ffcc5c;font-size: medium;">
			...
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Degree:</td>
			<td style="text-align: left;" class="form-control"><input type="text" name="deg" value="<%=rs.getString(7) %>"></td></tr>
      ...
      <div class="modal-footer">
        ...
        <div class="panel-body" style="background-color: #555555;">
          <table align="center" style="color: #ffcc5c;font-size: medium;">
			...
			<tr><td style="text-align: right; padding-right: 8px;padding-bottom: 5px;">Degree:</td><td style="text-align: left;" class="form-control"><%=rs.getString(7) %></td></tr>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
 		 ...
 		 <div class="panel panel-default text-center" style="background-color: #fff; padding-bottom: 10px;border: 2px;border-color: #555555;">
