...
<table  align="center" 
			...
			<tr><td><input type="hidden" name="role" value="medical"></td></tr>
			...
			<tr>
			<td style="border: 0px;">
			<input type="radio" name="gender" size="35" value="Male" checked="checked" class="form-control"> Male
			<input type="radio" name="gender" size="35" value="Female"> Female
			<input type="radio" name="gender" size="35" value="Others"> Others</td>
			</tr>
			...
			<tr>
			 <tr><td style="border: 0px;text-align: left;">Enter Degree</td></tr>
			<tr><td style="border: 0px;"><input type="text" name="deg" placeholder="Enter your highest qualification" size="35" class="form-control" required></td></tr>
			<tr>
