...
<div class="container-fluid text-center">
    ...
    <h2 style="color: #ffcc5c;">Events near you </h2> 
 </div> 
     ...
     <%
      try{
        ...
        <%
	           	...
	           	String sql2="select name,venue,loc,sdate,stime,guest,comm,evntid,pid,pname from event where loc=?";
	           	...
	           	while(rs2.next()){
        			...
        			<div class="panel-body" style="overflow: auto; height: 400px;">
         			 <div class="text-center" 
          				...
          				<p style="color:#ff1d8e ; font-size: 25px;padding: 5px;"><span class="glyphicon glyphicon"></span> " <%=rs2.getString(1) %> "</p>
